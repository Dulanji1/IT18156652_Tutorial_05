package com.example.tutefirebase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);
            ...
            // Hooks
            txtID = findViewById(R.id.input_t1);
            txtName = findViewById(R.id.uname_t2);
            txtAddress = findViewById(R.id.address_t3);
            txtContactNo = findViewById(R.id.con_t4);
